...
for i=1:1:100
    x_plot(i) = x_aux(1)+(( x_aux(10) - x_aux(1) )*(i/93)) ; // anda-se de centésimo a centésimo, partindo do x_aux(1) até o x_aux (10). Isso                                                     // ocorre pra interpolação ter pontos suficientes pra ficar mais "suave"
